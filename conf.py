...
BLOG_AUTHOR = "Prateek Mehta"  # (translatable)
BLOG_TITLE = "Prateek Mehta"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://prtkm.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://prtkm.github.io/"
BLOG_EMAIL = "prateekmehta.in@gmail.com"
BLOG_DESCRIPTION = "Chemical Engineering, Python, Simulations, etc"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/posts/about-me', 'About me', 'icon-user'),
        ('https://linkedin.com/in/prtkm', 'Connect with me on LinkedIn', 'icon-linkedin'),
        ('https://twitter.com/prtk_m', 'Follow me on Twitter', 'icon-twitter'),
        ('https://github.com/prtkm', 'Find me on Github', 'icon-github'),
    )
}
